...
* **Rolling manuals**: These manuals are set to change every time there is a new feature or an improvement, and they get the most updates during the lifetime of the project.
* **Stable manuals**: These manuals are frozen in one version or version series, and they get less frequent updates, depending on if a release warrants a change in the manual.
* **Obsolete manuals**: These manuals are frozen permanently with no changes accepted, and they are usually disconnected from repositories (due to a project or a version being end of life) but archived for preservation purposes.

If you want to check them out, consult the organization list in the first page of this manual here:
...
* Nitrocid KS
  ...
  * 0.2.0.x series
    ...
    * [Release Candidate](https://app.gitbook.com/o/fj052nYlsxW9IdL3bsZj/s/AQ7s8zxhhCvO5TZuMXKz/) (December 25th, 2025)
    * RTM (February 12th, 2026)
* Terminaux
  ...
  * 8.x series
    * [Version 8.0](https://app.gitbook.com/o/fj052nYlsxW9IdL3bsZj/s/mrnXpY6rZdP6tC8fv7t9/) (October 20th, 2025)
